    ...
    $("#q15btn").on("click", function (e) {
        ...
        if ($("input[name=group15]:checked").val() === undefined) {
            ...
            $.get("/api/results/" + match, function (data) {
                ...
                $(".foodAppend").html("<div class='leftDiv col s12 l4'>" + "<h4>" + data.data.detailData[0].Name + "</h4>" + "<p>" + data.data.detailData[0].Description + "</p>" + "</div>" + "<div class='middleDiv col s12 l4'>" + "<h4>" + data.data.detailData[1].Name + "</h4>" + "<p>" + data.data.detailData[1].Description + "</p>" + "</div>" + "<div class='rightDiv col s12 l4'>" + "<h4>" + data.data.detailData[2].Name + "</h4>" + "<p>" + data.data.detailData[2].Description + "</p>" + "</div>");
